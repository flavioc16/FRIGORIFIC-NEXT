            ...
            <ThemedView style={styles.container}>
              ...
              <View style={styles.usernameContainer}>
                <FontAwesome
                  name="user"
                  size={20}
                  color={useThemeColor({}, 'icon')} // Ícone dinâmico com base no tema
              ...
              <View style={styles.passwordContainer}>
                <TextInput
                  ...
                  style={[
                    ...
                    { borderColor: borderColor, color: textColor }, // Borda e texto dinâmicos
                  ]}
                  placeholder="Senha"
                ...
                >
                  <FontAwesome
                    ...
                    size={24}
                    color={iconColor} // Ícone dinâmico com base no tema
                  />
                </TouchableOpacity>
              </View>
